...
![并查集森林表示法（child → parent 指针）](images/ch08-forest-representation.png)
...
![并查集数组表示法（S[element] = parent index）](images/ch08-array-representation.png)
...
![朴素 Union 导致的最坏情况退化链](images/ch08-worst-case-chain.png)
...
![线段树结构（完全二叉树，每个节点代表一个区间）](images/ch08-segtree-structure.png)
...
![线段树范围查询（三种重叠情况：无/完全/部分重叠）](images/ch08-segtree-query.png)
...
**Step 1: 查找并更新叶节点**
![线段树更新 — 找到待更新叶节点](images/ch08-segtree-update-find.png)

到达叶节点 `[3]`，将值从 8 改为 9。

**Step 2: 回溯更新祖先**
![线段树更新 — 回溯更新所有祖先节点](images/ch08-segtree-update-backtrack.png)
